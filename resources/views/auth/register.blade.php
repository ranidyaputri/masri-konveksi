      ...
      <div class="register-form">
        <form method="POST" action="{{ route('register.create') }}">
          ...
          <div class="mb-5">
            ...
            <input type="email" name="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-300 focus:border-primary-300 block w-full p-2.5" placeholder="name@example.com" required>
          </div>
          <div class="mb-5">
